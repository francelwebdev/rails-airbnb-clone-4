...
amp = Equipment.create(title: 'Sweet Amp', description: 'Marshall Amp', user: alex, address: "25 Cuff Point, E2 7PP, London", category: "Guitars", price: "50")
amp.photo_url = ampurl


guitarurl = "https://www.guitarburn.com/blog/wp-content/uploads/2016/08/gibson_acoustic_graphic1.jpg"
guitar = Equipment.create(title: 'Guitar', description: 'Gibson electronic guitar', user: bob, address: "25 Cuff Point, E2 7PP, London")
